      ...
      <v-dialog v-model="show" max-width="800px">
        <v-card class="px-4 py-4">
          <v-card-title>
            <h2
              class="ml-3"
              style="color: #1976d2; margin-bottom: 10px; margin-top: 10px"
            >
              Comments
            </h2>
          </v-card-title>
          <v-card-text>
            <v-container fluid>
              <v-data-iterator
                :items="comments"
                :items-per-page="comments.length"
                hide-default-footer
              >
                <template v-slot:default="props">
                  <v-row>
                    ...
                    >
                      <v-card>
                        <v-card-title
                          class="subheading font-weight-semibold mb-n3"
                        >
                          ...
                          <v-btn
                            fab
                            small
                            v-if="currentUser.sub === item.author_username"
                            color="red"
                            dark
